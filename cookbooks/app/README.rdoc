...
<tt>app_php</tt>, app_tomcat, app_passenger, app_django, <tt>app_jboss</tt> or a user created application
provider).
...
<tt>app_tomcat</tt>, or <tt>app_jboss</tt> cookbooks.
...
This includes <tt>app_php</tt>, <tt>app_tomcat</tt>, <tt>app_passenger</tt> and <tt>app_django</tt> and <tt>app_jboss</tt>
