...
recipe "sys_firewall::setup_fw_rules", "multiple port enabled"
...
attribute "sys_firewall/logging_enabled",
  :display_name => "Enable FW Logging", 
  :description => "Enables Logging Dropped packets to /var/log/messages",
  :required => "optional",
  :choice => ["enabled", "disabled"],
  :default => "enabled",
  :recipes => [ "sys_firewall::default" ]
...
attribute "sys_firewall/rule/port",
  ...
  :required => "required",
  :recipes => [ "sys_firewall::setup_rule","sys_firewall::setup_fw_rules"]
