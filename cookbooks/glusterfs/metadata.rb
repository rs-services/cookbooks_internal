...
recipe "glusterfs::volume_restore", "restores volume"
...
attribute "glusterfs/cache_size",
  ...
  :description => "Gluster Performance Cache Size",
  :required => "optional",
...
restore_recipes = [
  ...
  "block_device::do_secondary_restore",
  "glusterfs::volume_restore",
  "glusterfs::config_restored_volume_attrs"
]
...
devices.sort.each_with_index.map do |device, index|
  ...
  attribute "block_device/devices/#{device}/mount_point",
    ...
    :recipes => ["block_device::setup_block_device", "block_device::default", all_recipes, restore_recipes ] 
